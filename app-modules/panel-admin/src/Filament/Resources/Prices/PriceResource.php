...
class PriceResource extends Resource
{
    ...
    {
        return __('panel-admin::resources.prices.navigation_label');
    }

    public static function getModelLabel(): string
    {
        return __('panel-admin::resources.prices.model_label');
    }

    public static function getPluralModelLabel(): string
    {
        return __('panel-admin::resources.prices.plural_model_label');
    }
