...
namespace TresPontosTech\PanelAdmin\Filament\Resources\SupportTickets\Schemas;
        ...
        return $schema->components([
            Section::make(__('support::resources.support_tickets.sections.requester'))
                ...
                ->schema([
                    ...
                    TextEntry::make('visitor_company_name')
                        ->label(__('support::resources.support_tickets.fields.visitor_company_name'))
                        ->placeholder('—'),
                ]),
            ...
            Section::make(__('support::resources.support_tickets.sections.metadata'))
                ->icon(Heroicon::InformationCircle)
                ->columns(4)
                ->collapsed()
                ->schema([
                    TextEntry::make('url')
                        ->label(__('support::resources.support_tickets.fields.url'))
                        ->placeholder('—')
                        ->columnSpanFull(),
                    TextEntry::make('browser')
                        ->label(__('support::resources.support_tickets.fields.browser'))
                        ->placeholder('—'),
                    TextEntry::make('device')
                        ->label(__('support::resources.support_tickets.fields.device'))
                        ->placeholder('—'),
                    TextEntry::make('environment')
                        ->label(__('support::resources.support_tickets.fields.environment'))
                        ->placeholder('—'),
