...
<section class="flex flex-col mx-auto mb-28 sm:mb-44">
    <x-headline class="max-w-full!" align="left" contentLayout="grid grid-cols-1 lg:grid-cols-[1fr_2fr] lg:gap-12">
        <x-slot:title>
            {{ $title }}
        </x-slot:title>
        <x-slot:description>
