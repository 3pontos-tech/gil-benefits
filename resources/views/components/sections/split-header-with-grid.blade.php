...
<section class="flex flex-col mx-auto mb-28 sm:mb-44 bg-gradient-to-r from-brand-primary to-brand-secondary p-8 lg:p-16 rounded-xl">
    <div class="grid grid-cols-1 lg:grid-cols-[1.5fr_2fr] gap-12 lg:gap-12">
